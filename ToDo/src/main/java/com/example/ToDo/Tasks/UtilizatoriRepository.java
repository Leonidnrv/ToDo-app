...
public interface UtilizatoriRepository extends JpaRepository<Utilizator, Long> {
    ...
    Long idByNume(@Param("nume") String nume);//aceasta functie primeste numele unui utilizator si intoarce id-ul din tabela users (folosita la salvarea de task-uri). Intoarce null daca nu gaseste nimic.
